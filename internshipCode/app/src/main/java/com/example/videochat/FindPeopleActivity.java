...
public class FindPeopleActivity extends AppCompatActivity {
        ...
        searchET.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence charSeq, int start, int count, int after) {
                if (searchET.getText().toString().equals("")){
                    Toast.makeText(FindPeopleActivity.this, "Please write a user name to search!", Toast.LENGTH_SHORT).show();
                }else{
    ...
    protected void onStart() {
        ...
        if(str.equals("")){
            ...
            options = new FirebaseRecyclerOptions.Builder<Contacts>().setQuery(usersRef.orderByChild("name")
                    .startAt(str)
                    .endAt(str + "\uf8ff"), Contacts.class).build();
        }
        FirebaseRecyclerAdapter<Contacts, FindFriendsViewHolder>
