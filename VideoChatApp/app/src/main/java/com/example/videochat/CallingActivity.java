...
public class CallingActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        userRef.child(receiverUserId).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            //DataSnapshot instance contains data from a Firebase Database location. Any time you read Database data,
            // you receive the data as a DataSnapshot.
            public void onDataChange( DataSnapshot dataSnapshot) {
//                Checks if users is busy or not if true receiver is not busy and will receive a call
    ...
    private void cancelCallingUser() {
        // From sender side cancel calling
        ...
        // From receiver side cancel calling
