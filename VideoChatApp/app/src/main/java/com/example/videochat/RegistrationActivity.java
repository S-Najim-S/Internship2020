    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent")){
                    ...
                    if (verificationCode.equals("")){
                        Toast.makeText(RegistrationActivity.this, " Please write the verification code !", Toast.LENGTH_LONG).show();
                    }else {
                    ...
                    if (!phoneNumber.equals("")){
                        ...
                        loadingBar.setMessage("Please Enter a phone number!");
                        loadingBar.setCanceledOnTouchOutside(false);
                        loadingBar.show();
                        ...
                        Toast.makeText(RegistrationActivity.this, "Please wait until we verify your phone number!", Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                loadingBar.dismiss();
                Toast.makeText(RegistrationActivity.this, " Code has been sent to your  phone number!", Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Congratulations you are logged in!", Toast.LENGTH_LONG).show();
