...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void saveUserData() {
        ...
        if (ImageUri == null){
            ...
            Toast.makeText(this, "You must have a username!", Toast.LENGTH_SHORT).show();
        }else if( getUserStatus.equals("")){
            Toast.makeText(this, "You must have a Bio!", Toast.LENGTH_SHORT).show();
        }else{
                        ...
                        userReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).updateChildren(profileMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    ...
                                    Toast.makeText(SettingsActivity.this, "Profile has been saved!", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
